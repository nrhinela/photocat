...
if [ -z "$PROJECT_ID" ] || [ "$PROJECT_ID" = "(unset)" ]; then
    ...
    echo "Pass project as first arg, set PROJECT_ID env var, or run: gcloud config set project <project-id>"
    exit 1
fi
...
echo ""
echo "Next steps:"
echo "  1. Point your domain (cdn.zoltag.app) to: $CDN_IP"
