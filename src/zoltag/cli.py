...
from zoltag.metadata import Asset, ImageMetadata, KeywordModel, MachineTag, Tenant as TenantModel
...
def backfill_thumbnails(
    ...
    Use --dry-run to preview changes first."""
    from zoltag.cli.commands.thumbnails import backfill_thumbnails_command
